...
- Name: critical-paths.spec.ts >> Deal Pipeline – Kanban drag-and-drop >> drag deal card to next stage column triggers stage-move API call
- Location: e2e/critical-paths.spec.ts:466:3
